...
// }
// else{
// echo "<h2>Sorry, wrong password!</h1>";
// }

	//Здесь нарушены все мыслимые нормы безопастности:
	// 1. Слабый пароль
...
//Утраняем проблему секрета в коде
...
if ($numRows == 0) {
	echo "<h2>Sorry, wrong password or username!</h1>";
}
else {
	echo "<h1>Hello, $user!</h1>";
	$_SESSION["user"] = $user;
